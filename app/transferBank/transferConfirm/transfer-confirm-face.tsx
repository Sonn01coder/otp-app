...
import { View, Text, TouchableOpacity, StyleSheet, ActivityIndicator, Dimensions, Alert, Linking, Pressable } from 'react-native';
    ...
    const captureFace = async () => {
        ...
        try {
            ...
            if (photo.uri) {
                ...
                if (newRes) {
                    (navigation as any).replace('FaceTransferSuccess', { portrait: photo.uri, amount: amount });
                }
            }
        } catch (error) {
